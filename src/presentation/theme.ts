...
export const LAYER_THEME: Record<CellColor, LayerTheme> = {
  ORANGE: {
    ...
    banner: 'bg-orange-950/50 border-b-2 border-orange-500 text-orange-400',
  ...
  SKY: {
    ...
    banner: 'bg-sky-950/50 border-b-2 border-sky-400 text-sky-400',
  ...
  EMERALD: {
    ...
    banner: 'bg-emerald-950/50 border-b-2 border-emerald-500 text-emerald-400',
  ...
  LIME: {
    ...
    banner: 'bg-lime-950/50 border-b-2 border-lime-400 text-lime-400',
    surface: 'bg-lime-950/40',
  },
  FUCHSIA: {
    bg: 'bg-fuchsia-500',
    ...
    banner: 'bg-fuchsia-950/50 border-b-2 border-fuchsia-500 text-fuchsia-400',
    surface: 'bg-fuchsia-950/40',
  },
};
